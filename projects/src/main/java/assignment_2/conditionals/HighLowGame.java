...
public class HighLowGame {
    ...
    public static void main(String args[]) throws IOException {
        ...
        while (true) {
            ...
            if (guess < answer) {
                System.out.println(String.format("You're too low. Pick a higher number.", String.valueOf(guess)));
                // break;
            }

            if (guess > answer) {
                System.out.println(String.format("You're too high. Pick a lower number.", String.valueOf(guess)));
                // break;
            }
        }
    }
